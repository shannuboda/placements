...
$(document).ready(function () {
    ...
    $(document).ready(function() {
        $(".checkalls").click(function() {
                $(".firsttabdis").css("display","block");
        });
        $(".checkallh").click(function() {
                $(".firsttabdis").css("display","none");
        });
    });
...
const pillsWrapper = document.querySelector(".tab-pills");
const tabContent = document.querySelectorAll(".tab-content");

pills.forEach((pill, i) => {
  pill.addEventListener("click", () => {
    pillsWrapper.className = `tab-pills active-${i + 1}`;
    tabContent.forEach((tab, j) => {
        ...
        var schid = $(this).val();
           $.ajax({
                ...
                success: function(res){
                    ...
                    var status = finalval['status'];
                    if(status == '200'){
                        //$("#user_name").val(finalval['user_name']);
